...
def object_detection_api(model, device, img_path, output_image_path, threshold, rect_th, text_size, text_th, NAMES):
  
  boxes, pred_cls = get_prediction(model, device, img_path, threshold, NAMES) # Get predictions
...
def main(args):
  ...
  for i in range (0, len(imgs)):
    ...
    object_detection_api(model, args.device, img_path, output_image_path, args.threshold, args.rect_th, args.text_size, args.text_th, NAMES)
